...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(1034, 561);
			...
			this->label3->Location = System::Drawing::Point(20, 866);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(235, 19);
			this->label3->TabIndex = 4;
			this->label3->Text = L"Zobrazenie podrobností úlohy:";
			this->label3->Click += gcnew System::EventHandler(this, &helpDialog::label3_Click);
			// 
			// panel3
			// 
			this->panel3->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"panel3.BackgroundImage")));
			this->panel3->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->panel3->Location = System::Drawing::Point(24, 608);
			...
			this->label2->Location = System::Drawing::Point(20, 586);
			...
			this->panel2->Location = System::Drawing::Point(17, 46);
